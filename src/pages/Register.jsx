          ...
          <div className="max-w-md mx-auto text-center">
            ...
            <form onSubmit={handleSubmit} className="space-y-5 text-right">
              ...
              <div className="relative group">
                ...
                <div className="absolute right-3 top-1/2 -translate-y-1/2 group-focus-within:text-[#FDE6C3] transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#094B50]/40" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-2.25c0-.865-.42-1.675-1.138-2.19a9.75 9.75 0 00-4.208-1.46 1.125 1.125 0 00-1.227.848l-.437 1.746a.75.75 0 01-1.03.546 17.25 17.25 0 01-7.22-7.22.75.75 0 01.546-1.03l1.746-.437a1.125 1.125 0 00.848-1.227 9.75 9.75 0 00-1.46-4.208A2.25 2.25 0 006.75 2.25h-2.5a2.25 2.25 0 00-2.25 2.25v2.25z" />
                  </svg>
                </div>
              </div>
